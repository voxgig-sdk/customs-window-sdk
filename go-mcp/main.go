// Command CustomsWindow-mcp is an MCP server exposing the CustomsWindow
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CustomsWindow_list  — list records of an entity
//	CustomsWindow_load  — load a single record of an entity
//
