...
function envOverride(m) {
    if ('TRUE' === process.env.CUSTOMS_WINDOW_TEST_LIVE ||
        'TRUE' === process.env.CUSTOMS_WINDOW_TEST_OVERRIDE) {
    ...
    m.CUSTOMS_WINDOW_TEST_EXPLAIN = process.env.CUSTOMS_WINDOW_TEST_EXPLAIN || m.CUSTOMS_WINDOW_TEST_EXPLAIN;
    return m;
}
