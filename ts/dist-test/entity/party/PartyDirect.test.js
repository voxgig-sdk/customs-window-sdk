...
(0, node_test_1.describe)('PartyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-party', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-party', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-party', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-party', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMS_WINDOW_TEST_PARTY_ENTID'];
...
//# sourceMappingURL=PartyDirect.test.js.map