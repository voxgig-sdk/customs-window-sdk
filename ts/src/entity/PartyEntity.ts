...
class PartyEntity extends CustomsWindowEntityBase<Party> {
  ...
  make(this: PartyEntity) {
    return new PartyEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: PartyLoadMatch, ctrl?: Control): Promise<PartyEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Party> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: PartyListMatch, ctrl?: Control): Promise<PartyEntity[]> {
  ...
  async create(this: any, reqdata?: PartyCreateData, ctrl?: Control): Promise<PartyEntity> {
  ...
  async update(this: any, reqdata?: PartyUpdateData, ctrl?: Control): Promise<PartyEntity> {
  ...
  async remove(
    this: any, reqmatch?: PartyRemoveMatch, ctrl?: Control,
  ): Promise<PartyEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PartyEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
