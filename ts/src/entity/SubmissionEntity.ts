...
import type {
  ...
  SubmissionRemoveMatch,
} from '../CustomsWindowTypes'

// TODO: needs Entity superclass
class SubmissionEntity extends CustomsWindowEntityBase<Submission> {
  ...
  async load(this: any, reqmatch?: SubmissionLoadMatch, ctrl?: Control): Promise<SubmissionEntity> {
  ...
  async create(this: any, reqdata?: SubmissionCreateData, ctrl?: Control): Promise<SubmissionEntity> {
  ...
  async update(this: any, reqdata?: SubmissionUpdateData, ctrl?: Control): Promise<SubmissionEntity> {
  ...
  async remove(
    this: any, reqmatch?: SubmissionRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SubmissionEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
