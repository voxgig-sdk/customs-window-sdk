...
// CustomsWindow SDK SubmissionDetail entity
...
class SubmissionDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SubmissionDetailEntity($this->_client, $opts);
    }

    /**
     * @param SubmissionDetail|array $args SubmissionDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return SubmissionDetail|array The current SubmissionDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubmissionDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubmissionDetail fields).
     */
    ...
    /**
     * Create a new SubmissionDetail.
     *
     * @param SubmissionDetailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubmissionDetailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubmissionDetail|array The created SubmissionDetail as an assoc-array at the
