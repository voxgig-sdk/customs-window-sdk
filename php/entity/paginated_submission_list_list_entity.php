...
class PaginatedSubmissionListListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "paginated_submission_list_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedSubmissionListListEntity($this->_client, $opts);
    }

    /**
     * @param PaginatedSubmissionListList|array $args PaginatedSubmissionListList data (assoc-array) to store.
     */
    ...
    /**
     * @return PaginatedSubmissionListList|array The current PaginatedSubmissionListList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaginatedSubmissionListList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaginatedSubmissionListList fields).
     */
