...
// CustomsWindow SDK Party entity
...
class PartyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PartyEntity($this->_client, $opts);
    }

    /**
     * @param Party|array $args Party data (assoc-array) to store.
     */
    ...
    /**
     * @return Party|array The current Party data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Party fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Party fields).
     */
     ...
     * Load a single Party.
     *
     * @param PartyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PartyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Party|array The loaded Party as an assoc-array at the
    ...
    /**
     * List Party items matching the given filter.
     *
     * @param PartyListMatch|array|null $reqmatch Match filter (any subset
     *   of Party fields) as an assoc-array; PartyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Party[]|array A list of Party items as assoc-arrays at
     ...
     * Create a new Party.
     *
     * @param PartyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PartyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Party|array The created Party as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
     ...
     *
     * @param PartyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PartyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Party|array The updated Party as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Party matching the given criteria.
     *
     * @param PartyRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PartyRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Party|array The removed Party as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
