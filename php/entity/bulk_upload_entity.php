...
// CustomsWindow SDK BulkUpload entity
...
class BulkUploadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BulkUploadEntity($this->_client, $opts);
    }

    /**
     * @param BulkUpload|array $args BulkUpload data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = CustomsWindowHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return BulkUpload|array The current BulkUpload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BulkUpload fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = CustomsWindowHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of BulkUpload fields).
     */
    ...
    /**
     * Load a single BulkUpload.
     *
     * @param BulkUploadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BulkUploadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkUpload|array The loaded BulkUpload as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = CustomsWindowHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List BulkUpload items matching the given filter.
     *
     * @param BulkUploadListMatch|array|null $reqmatch Match filter (any subset
     *   of BulkUpload fields) as an assoc-array; BulkUploadListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkUpload[]|array A list of BulkUpload items as assoc-arrays at
     *   the SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new BulkUpload.
     *
     * @param BulkUploadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BulkUploadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkUpload|array The created BulkUpload as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing BulkUpload.
     *
     * @param BulkUploadUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BulkUploadUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkUpload|array The updated BulkUpload as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an BulkUpload matching the given criteria.
     *
     * @param BulkUploadRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BulkUploadRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkUpload|array The removed BulkUpload as an assoc-array at the
     *   SDK boundary; throws CustomsWindowError on failure (item-5 convention).
     */
