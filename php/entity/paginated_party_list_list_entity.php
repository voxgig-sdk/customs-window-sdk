...
class PaginatedPartyListListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "paginated_party_list_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedPartyListListEntity($this->_client, $opts);
    }

    /**
     * @param PaginatedPartyListList|array $args PaginatedPartyListList data (assoc-array) to store.
     */
    ...
    /**
     * @return PaginatedPartyListList|array The current PaginatedPartyListList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaginatedPartyListList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaginatedPartyListList fields).
     */
