...
class PaginatedBulkUploadListListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "paginated_bulk_upload_list_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedBulkUploadListListEntity($this->_client, $opts);
    }

    /**
     * @param PaginatedBulkUploadListList|array $args PaginatedBulkUploadListList data (assoc-array) to store.
     */
    ...
    /**
     * @return PaginatedBulkUploadListList|array The current PaginatedBulkUploadListList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaginatedBulkUploadListList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaginatedBulkUploadListList fields).
     */
