...
// CustomsWindow SDK utility type

class CustomsWindowUtility
{
    ...
    public static function copy(CustomsWindowUtility $src): CustomsWindowUtility
    {
        $u = new CustomsWindowUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
