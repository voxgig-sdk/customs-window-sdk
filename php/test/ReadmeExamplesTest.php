...
// CustomsWindow SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CustomsWindowSDK::test)
...
{
    private const SDK_CLASS = 'CustomsWindowSDK';
    ...
    private const SDK_BASE = 'customswindow_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../customswindow_sdk.php';
