...
// CustomsWindow SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CustomsWindowOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CustomsWindowOmni::structfix($now, Struct::undef()))
                        !== json_encode(CustomsWindowOmni::structfix($val, Struct::undef()))) {
