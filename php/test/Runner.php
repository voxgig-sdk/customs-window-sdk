...
class CustomsWindowTestRunner
{
    ...
    {
        $live = self::getenv('CUSTOMS_WINDOW_TEST_LIVE');
        $override = self::getenv('CUSTOMS_WINDOW_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CUSTOMS_WINDOW_TEST_EXPLAIN');
...
class_alias('CustomsWindowTestRunner', 'Runner');
class_alias('CustomsWindowHelpers', 'Helpers');
