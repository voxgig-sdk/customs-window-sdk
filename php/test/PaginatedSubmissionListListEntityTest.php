...
class PaginatedSubmissionListListEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMS_WINDOW_TEST_PAGINATED_SUBMISSION_LIST_LIST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function paginated_submission_list_list_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMS_WINDOW_TEST_PAGINATED_SUBMISSION_LIST_LIST_ENTID");
