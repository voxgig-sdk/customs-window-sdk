...
class FileEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMS_WINDOW_TEST_FILE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function file_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMS_WINDOW_TEST_FILE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CUSTOMS_WINDOW_TEST_FILE_ENTID"]);
