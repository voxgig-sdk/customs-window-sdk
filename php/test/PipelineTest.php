...
// CustomsWindow SDK pipeline test
//
...
{
    private static function utility(): CustomsWindowUtility
    {
        return new CustomsWindowUtility();
    }
    ...
    private static function ctx(array $over = []): CustomsWindowContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CustomsWindowContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CustomsWindowOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CustomsWindowError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CustomsWindowOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CustomsWindowMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CustomsWindowOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CustomsWindowMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CustomsWindowOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CustomsWindowMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomsWindowSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CustomsWindowMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CustomsWindowResponse([]),
            'result' => new CustomsWindowResult([]),
        ]);
        [, $err] = CustomsWindowMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CustomsWindowSpec([]),
            'response' => null,
            'result' => new CustomsWindowResult([]),
        ]);
        [, $err] = CustomsWindowMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CustomsWindowSpec(['step' => 's']),
            'response' => new CustomsWindowResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CustomsWindowResult([]),
        ]);
        [, $err] = CustomsWindowMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomsWindowSpec(['step' => 's']),
            'response' => new CustomsWindowResponse(self::resp(200, ['v' => 1])),
            'result' => new CustomsWindowResult([]),
        ]);
        [, $err] = CustomsWindowMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomsWindowSpec(['step' => 's']),
            'response' => new CustomsWindowResponse(self::resp(200, ['v' => 2])),
            'result' => new CustomsWindowResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CustomsWindowMakeResponse::call($ctx);
    ...
    {
        $preset = new CustomsWindowResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CustomsWindowSpec([]),
            'response' => new CustomsWindowResponse([]),
            'result' => new CustomsWindowResult([]),
        ...
        [$got, $err] = CustomsWindowMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CustomsWindowResult([])]);
        [, $err] = CustomsWindowMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CustomsWindowSpec([]), 'result' => null]);
        [, $err] = CustomsWindowMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomsWindowSpec(['step' => 's']),
            'result' => new CustomsWindowResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CustomsWindowOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomsWindowMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomsWindowSpec(['step' => 's']),
            'result' => new CustomsWindowResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CustomsWindowOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomsWindowMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomsWindowResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CustomsWindowSpec([]),
            'result' => new CustomsWindowResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CustomsWindowMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomsWindowMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CustomsWindowError('boom', 'boom');
        $utility->fetcher = function (CustomsWindowContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomsWindowSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CustomsWindowMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CustomsWindowContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CustomsWindowMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CustomsWindowResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CustomsWindowMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CustomsWindowContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomsWindowSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CustomsWindowMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CustomsWindowResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CustomsWindowSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CustomsWindowMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CustomsWindowMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CustomsWindowMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CustomsWindowResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CustomsWindowDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CustomsWindowResult(['ok' => false])]);
        $this->expectException(CustomsWindowError::class);
        CustomsWindowDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CustomsWindowResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CustomsWindowMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CustomsWindowMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CustomsWindowBaseFeature();
        $b = new CustomsWindowBaseFeature();
        CustomsWindowFeatureAdd::call($ctx, $a);
        CustomsWindowFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CustomsWindowBaseFeature
    {
        $f = new CustomsWindowBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CustomsWindowFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CustomsWindowContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CustomsWindowSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomsWindowPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CustomsWindowPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CustomsWindowResponse(['headers' => null]),
            'result' => new CustomsWindowResult([]),
        ]);
        CustomsWindowResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CustomsWindowResultBody::call($ctx);
