...
print_r(array_map(fn($item) => $item->data_get(), $submission));
```
...
| `file` | `array` | cuid-format identifier for this entity. |
| `green_routed_no` | `int` |  |
...
| `client` | `array` |  |
| `company_member` | `array` | cuid-format identifier for this entity. |
| `consignee` | `array` |  |
| `consignor` | `array` |  |
| `created_at` | `string` |  |
| `declarant` | `array` | cuid-format identifier for this entity. |
