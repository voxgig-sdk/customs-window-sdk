...
// CustomsWindow SDK paging feature
...
class CustomsWindowPagingFeature extends CustomsWindowBaseFeature
{
    ...
    private function _graphql_pre_request(CustomsWindowContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(CustomsWindowContext $ctx): bool
    {
