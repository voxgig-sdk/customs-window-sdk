...
// CustomsWindow SDK cache feature
...
class CustomsWindowCacheFeature extends CustomsWindowBaseFeature
{
    ...
    private function _through(CustomsWindowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
