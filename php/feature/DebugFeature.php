...
// CustomsWindow SDK debug feature
...
class CustomsWindowDebugFeature extends CustomsWindowBaseFeature
{
    ...
    private function _finish(CustomsWindowContext $ctx, bool $ok): void
    {
