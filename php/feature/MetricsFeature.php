...
// CustomsWindow SDK metrics feature
...
class CustomsWindowMetricsFeature extends CustomsWindowBaseFeature
{
    ...
    private function _record(CustomsWindowContext $ctx, bool $ok): void
    {
