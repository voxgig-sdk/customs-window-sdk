...
// CustomsWindow SDK utility: fetcher

class CustomsWindowFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CustomsWindowSDK/1.0)';
    ...
    public static function call(CustomsWindowContext $ctx, string $fullurl, array $fetchdef): array
    {
