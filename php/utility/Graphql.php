...
// CustomsWindow SDK utility: graphql
//
...
class CustomsWindowGraphql
{
    ...
    // equivalent.
    public static function body(CustomsWindowContext $ctx): mixed
    {
    ...
    public static function errors(CustomsWindowContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
