...
function runner.env_override(m)
  local live = runner.getenv("CUSTOMSWINDOW_TEST_LIVE")
  local override = runner.getenv("CUSTOMSWINDOW_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CUSTOMSWINDOW_TEST_EXPLAIN")
