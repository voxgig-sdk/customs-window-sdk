...
function runner.env_override(m)
  local live = runner.getenv("CUSTOMS_WINDOW_TEST_LIVE")
  local override = runner.getenv("CUSTOMS_WINDOW_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CUSTOMS_WINDOW_TEST_EXPLAIN")
