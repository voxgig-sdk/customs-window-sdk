...
describe("FileEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CUSTOMS_WINDOW_TEST_FILE_ENTID JSON to run live")
      return
    end
...
function file_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CUSTOMS_WINDOW_TEST_FILE_ENTID")
