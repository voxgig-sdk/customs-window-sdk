...
local SubmissionDetailEntity = {}
SubmissionDetailEntity.__index = SubmissionDetailEntity


function SubmissionDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubmissionDetailEntity)
  self._name = "submission_detail"
  self._client = client
...
function SubmissionDetailEntity:get_name()
  return self._name
end


function SubmissionDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubmissionDetailEntity.new(self._client, opts)
end
...
function SubmissionDetailEntity:mark_deleted()
  self._deleted = true
end


function SubmissionDetailEntity:deleted()
  return true == self._deleted
end


function SubmissionDetailEntity:data_set(args)
  if args ~= nil then
...
function SubmissionDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubmissionDetailEntity:match_set(args)
  if args ~= nil then
...
function SubmissionDetailEntity:match_get()
...
function SubmissionDetailEntity:stream(action, args, callopts)
...
---@param reqdata SubmissionDetailCreateData
---@param ctrl? table
---@return SubmissionDetail
---@return string? err
function SubmissionDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SubmissionDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
