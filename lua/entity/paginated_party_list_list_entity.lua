-- CustomsWindow SDK PaginatedPartyListList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PaginatedPartyListListEntity = {}
PaginatedPartyListListEntity.__index = PaginatedPartyListListEntity


function PaginatedPartyListListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaginatedPartyListListEntity)
  self._name = "paginated_party_list_list"
  self._client = client
...
function PaginatedPartyListListEntity:get_name()
  return self._name
end


function PaginatedPartyListListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaginatedPartyListListEntity.new(self._client, opts)
end
...
function PaginatedPartyListListEntity:mark_deleted()
  self._deleted = true
end


function PaginatedPartyListListEntity:deleted()
  return true == self._deleted
end


function PaginatedPartyListListEntity:data_set(args)
  if args ~= nil then
...
function PaginatedPartyListListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaginatedPartyListListEntity:match_set(args)
  if args ~= nil then
...
function PaginatedPartyListListEntity:match_get()
...
function PaginatedPartyListListEntity:stream(action, args, callopts)
...
function PaginatedPartyListListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PaginatedPartyListListEntity
