...
local BulkUploadEntity = {}
BulkUploadEntity.__index = BulkUploadEntity


function BulkUploadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BulkUploadEntity)
  self._name = "bulk_upload"
  self._client = client
...
function BulkUploadEntity:get_name()
  return self._name
end


function BulkUploadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BulkUploadEntity.new(self._client, opts)
end
...
function BulkUploadEntity:mark_deleted()
  self._deleted = true
end


function BulkUploadEntity:deleted()
  return true == self._deleted
end


function BulkUploadEntity:data_set(args)
  if args ~= nil then
...
function BulkUploadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BulkUploadEntity:match_set(args)
  if args ~= nil then
...
function BulkUploadEntity:match_get()
...
function BulkUploadEntity:stream(action, args, callopts)
...
---@param reqmatch BulkUploadLoadMatch
---@param ctrl? table
---@return BulkUpload
---@return string? err
function BulkUploadEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch BulkUploadListMatch
---@param ctrl? table
---@return BulkUpload[]
---@return string? err
function BulkUploadEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata BulkUploadCreateData
---@param ctrl? table
---@return BulkUpload
---@return string? err
function BulkUploadEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata BulkUploadUpdateData
---@param ctrl? table
---@return BulkUpload
---@return string? err
function BulkUploadEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch BulkUploadRemoveMatch
---@param ctrl? table
---@return BulkUpload
---@return string? err
function BulkUploadEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function BulkUploadEntity:_run_op(ctx, post_done)
  local utility = self._utility
