-- CustomsWindow SDK PaginatedSubmissionListList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PaginatedSubmissionListListEntity = {}
PaginatedSubmissionListListEntity.__index = PaginatedSubmissionListListEntity


function PaginatedSubmissionListListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaginatedSubmissionListListEntity)
  self._name = "paginated_submission_list_list"
  self._client = client
...
function PaginatedSubmissionListListEntity:get_name()
  return self._name
end


function PaginatedSubmissionListListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaginatedSubmissionListListEntity.new(self._client, opts)
end
...
function PaginatedSubmissionListListEntity:mark_deleted()
  self._deleted = true
end


function PaginatedSubmissionListListEntity:deleted()
  return true == self._deleted
end


function PaginatedSubmissionListListEntity:data_set(args)
  if args ~= nil then
...
function PaginatedSubmissionListListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaginatedSubmissionListListEntity:match_set(args)
  if args ~= nil then
...
function PaginatedSubmissionListListEntity:match_get()
...
function PaginatedSubmissionListListEntity:stream(action, args, callopts)
...
function PaginatedSubmissionListListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PaginatedSubmissionListListEntity
