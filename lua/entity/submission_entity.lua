...
---@param reqmatch SubmissionLoadMatch
---@param ctrl? table
---@return Submission
---@return string? err
function SubmissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata SubmissionCreateData
---@param ctrl? table
---@return Submission
---@return string? err
function SubmissionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata SubmissionUpdateData
---@param ctrl? table
---@return Submission
---@return string? err
function SubmissionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch SubmissionRemoveMatch
---@param ctrl? table
---@return Submission
---@return string? err
function SubmissionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
