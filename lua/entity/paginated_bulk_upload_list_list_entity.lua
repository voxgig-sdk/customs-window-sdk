-- CustomsWindow SDK PaginatedBulkUploadListList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PaginatedBulkUploadListListEntity = {}
PaginatedBulkUploadListListEntity.__index = PaginatedBulkUploadListListEntity


function PaginatedBulkUploadListListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaginatedBulkUploadListListEntity)
  self._name = "paginated_bulk_upload_list_list"
  self._client = client
...
function PaginatedBulkUploadListListEntity:get_name()
  return self._name
end


function PaginatedBulkUploadListListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaginatedBulkUploadListListEntity.new(self._client, opts)
end
...
function PaginatedBulkUploadListListEntity:mark_deleted()
  self._deleted = true
end


function PaginatedBulkUploadListListEntity:deleted()
  return true == self._deleted
end


function PaginatedBulkUploadListListEntity:data_set(args)
  if args ~= nil then
...
function PaginatedBulkUploadListListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaginatedBulkUploadListListEntity:match_set(args)
  if args ~= nil then
...
function PaginatedBulkUploadListListEntity:match_get()
...
function PaginatedBulkUploadListListEntity:stream(action, args, callopts)
...
function PaginatedBulkUploadListListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PaginatedBulkUploadListListEntity
