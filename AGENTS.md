...
**Entities** (8): `BulkUpload`, `File`, `PaginatedBulkUploadListList`, `PaginatedPartyListList`, `PaginatedSubmissionListList`, `Party`, `Submission`, `SubmissionDetail`.
