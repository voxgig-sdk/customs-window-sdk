...
func registerSDKWords(r *eng.Registry, client *sdk.CustomsWindowSDK) {
...
func runOp(client *sdk.CustomsWindowSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
