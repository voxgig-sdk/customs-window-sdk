# CustomsWindow SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CustomsWindowSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CustomsWindowSDK(...) and CustomsWindowSDK.test(...) become
#      CustomsWindowSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "customswindow_sdk"
_SDK_CLASS = "CustomsWindowSDK"
...
_ENTITIES = {
    ...
    "File": "file",
    "PaginatedBulkUploadListList": "paginated_bulk_upload_list_list",
    "PaginatedPartyListList": "paginated_party_list_list",
    "PaginatedSubmissionListList": "paginated_submission_list_list",
    "Party": "party",
