    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMSWINDOW_TEST_PARTY_ENTID JSON to run live")
        client = setup["client"]
        ...
        party_ref01_data = helpers.to_map(party_ref01_ent.create(party_ref01_data, None))
        ...
        party_ref01_resdata_up0 = helpers.to_map(party_ref01_ent.update(party_ref01_data_up0_up, None))
...
def _party_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMSWINDOW_TEST_PARTY_ENTID"))
