    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMSWINDOW_TEST_SUBMISSION_ENTID JSON to run live")
        client = setup["client"]
        ...
        submission_ref01_data = helpers.to_map(submission_ref01_ent.create(submission_ref01_data, None))
        ...
        submission_ref01_resdata_up0 = helpers.to_map(submission_ref01_ent.update(submission_ref01_data_up0_up, None))
...
def _submission_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMSWINDOW_TEST_SUBMISSION_ENTID"))
