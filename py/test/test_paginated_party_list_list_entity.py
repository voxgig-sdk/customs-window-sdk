    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMS_WINDOW_TEST_PAGINATED_PARTY_LIST_LIST_ENTID JSON to run live")
        client = setup["client"]
...
def _paginated_party_list_list_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "CUSTOMS_WINDOW_TEST_PAGINATED_PARTY_LIST_LIST_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMS_WINDOW_TEST_PAGINATED_PARTY_LIST_LIST_ENTID"))
