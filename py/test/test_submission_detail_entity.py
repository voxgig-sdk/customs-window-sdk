    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMS_WINDOW_TEST_SUBMISSION_DETAIL_ENTID JSON to run live")
        client = setup["client"]
        ...
        submission_detail_ref01_data = helpers.to_map(runner.entity_data(submission_detail_ref01_ent.create(submission_detail_ref01_data, None)))
...
def _submission_detail_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "CUSTOMS_WINDOW_TEST_SUBMISSION_DETAIL_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMS_WINDOW_TEST_SUBMISSION_DETAIL_ENTID"))
