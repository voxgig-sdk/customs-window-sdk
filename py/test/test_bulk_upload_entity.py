    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMS_WINDOW_TEST_BULK_UPLOAD_ENTID JSON to run live")
        client = setup["client"]
        ...
        bulk_upload_ref01_data = helpers.to_map(runner.entity_data(bulk_upload_ref01_ent.create(bulk_upload_ref01_data, None)))
        ...
        bulk_upload_ref01_resdata_up0 = helpers.to_map(runner.entity_data(bulk_upload_ref01_ent.update(bulk_upload_ref01_data_up0_up, None)))
        ...
        bulk_upload_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(bulk_upload_ref01_data_dt0_loaded))
...
def _bulk_upload_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMS_WINDOW_TEST_BULK_UPLOAD_ENTID"))
