...
class SubmissionDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubmissionDetailEntity(self._client, opts)
    ...
    def data_get(self) -> SubmissionDetail:
    ...
    def match_get(self) -> SubmissionDetail:
    ...
    def create(self, reqdata: SubmissionDetailCreateData, ctrl=None) -> SubmissionDetail:
        utility = self._utility
