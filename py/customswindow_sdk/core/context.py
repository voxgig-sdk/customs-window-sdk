...
from customswindow_sdk.core.control import CustomsWindowControl
...
from customswindow_sdk.core.helpers import get_ctx_prop, to_map
...
class CustomsWindowContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CustomsWindowControl()
        ...
        if isinstance(sp, CustomsWindowSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CustomsWindowResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CustomsWindowResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CustomsWindowError(code, msg, self)
