...
class PaginatedSubmissionListListEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "paginated_submission_list_list"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    PaginatedSubmissionListListEntity.new(@_client, opts)
  end
  ...
  # @return [PaginatedSubmissionListList, Hash] the current PaginatedSubmissionListList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaginatedSubmissionListList fields)
  def match_get
