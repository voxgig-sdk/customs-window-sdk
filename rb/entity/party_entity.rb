...
class PartyEntity
  ...
  # @return [Party, Hash] the current Party data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Party fields)
  def match_get
  ...
  # Load a single Party.
  #
  # @param reqmatch [PartyLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Party.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Party, Hash] the loaded Party; raises CustomsWindowError on failure
  ...
  #
  # @param reqmatch [PartyListMatch, Hash, nil] match filter (any subset of
  #   Party fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Party>, Array] the matching Party items; raises CustomsWindowError on failure
  ...
  # Create a new Party.
  #
  # @param reqdata [PartyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Party, Hash] the created Party; raises CustomsWindowError on failure
  ...
  #
  # @param reqdata [PartyUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Party, Hash] the updated Party; raises CustomsWindowError on failure
  ...
  #
  # @param reqmatch [PartyRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Party, Hash] the removed Party; raises CustomsWindowError on failure
