...
class PaginatedBulkUploadListListEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "paginated_bulk_upload_list_list"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    PaginatedBulkUploadListListEntity.new(@_client, opts)
  end
  ...
  # @return [PaginatedBulkUploadListList, Hash] the current PaginatedBulkUploadListList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaginatedBulkUploadListList fields)
  def match_get
