...
class PaginatedPartyListListEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "paginated_party_list_list"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    PaginatedPartyListListEntity.new(@_client, opts)
  end
  ...
  # @return [PaginatedPartyListList, Hash] the current PaginatedPartyListList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaginatedPartyListList fields)
  def match_get
