...
class SubmissionDetailEntity
  ...
  def make
    opts = @_entopts.dup
    SubmissionDetailEntity.new(@_client, opts)
  end
  ...
  # @return [SubmissionDetail, Hash] the current SubmissionDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SubmissionDetail fields)
  def match_get
  ...
  #
  # @param reqdata [SubmissionDetailCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SubmissionDetail, Hash] the created SubmissionDetail; raises CustomsWindowError on failure
