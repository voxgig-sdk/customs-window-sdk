...
class PaginatedPartyListListEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CUSTOMSWINDOW_TEST_PAGINATED_PARTY_LIST_LIST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def paginated_party_list_list_basic_setup(extra)
  ...
  entid_env_raw = ENV["CUSTOMSWINDOW_TEST_PAGINATED_PARTY_LIST_LIST_ENTID"]
