...
class FileEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CUSTOMS_WINDOW_TEST_FILE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def file_basic_setup(extra)
  ...
  entid_env_raw = ENV["CUSTOMS_WINDOW_TEST_FILE_ENTID"]
