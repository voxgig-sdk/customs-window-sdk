...
#      offline in seeded test mode (CustomsWindowSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CustomsWindow_sdk.rb")
  SDK_CLASS = "CustomsWindowSDK"
