...
// CustomsWindow SDK rbac feature
...
class CustomsWindowRbacFeature extends CustomsWindowBaseFeature
{
    ...
    private function _required(CustomsWindowContext $ctx): ?string
    {
    ...
    private function _reject(CustomsWindowContext $ctx, string $required): void
    {
    ...
    private function _track(CustomsWindowContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
