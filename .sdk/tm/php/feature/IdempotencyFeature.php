...
// CustomsWindow SDK idempotency feature
...
class CustomsWindowIdempotencyFeature extends CustomsWindowBaseFeature
{
    ...
    private function _mutating(CustomsWindowContext $ctx): bool
    {
