...
// CustomsWindow SDK streaming feature
...
class CustomsWindowStreamingFeature extends CustomsWindowBaseFeature
{
    ...
    private function _iterate(CustomsWindowResult $result): \Generator
    {
    ...
    private function _streamable(CustomsWindowContext $ctx): bool
    {
