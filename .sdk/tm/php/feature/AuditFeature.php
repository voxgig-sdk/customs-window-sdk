...
// CustomsWindow SDK audit feature
...
class CustomsWindowAuditFeature extends CustomsWindowBaseFeature
{
    ...
    private function _emit(CustomsWindowContext $ctx, string $outcome): void
    {
