...
// CustomsWindow SDK proxy feature
...
class CustomsWindowProxyFeature extends CustomsWindowBaseFeature
{
    ...
    public function init(CustomsWindowContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CustomsWindowContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
