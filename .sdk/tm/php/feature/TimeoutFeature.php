...
// CustomsWindow SDK timeout feature
...
class CustomsWindowTimeoutFeature extends CustomsWindowBaseFeature
{
    ...
    private function _with_timeout(CustomsWindowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CustomsWindowContext $_ctx, float $ms): void
    {
        $client = $this->client;
