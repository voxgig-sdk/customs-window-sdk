...
// CustomsWindow SDK clienttrack feature
...
class CustomsWindowClienttrackFeature extends CustomsWindowBaseFeature
{
    ...
    public function PostConstruct(CustomsWindowContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CustomsWindow-SDK';
