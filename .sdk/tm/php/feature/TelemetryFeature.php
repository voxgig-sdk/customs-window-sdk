...
// CustomsWindow SDK telemetry feature
...
class CustomsWindowTelemetryFeature extends CustomsWindowBaseFeature
{
    ...
    private function _close(CustomsWindowContext $ctx, bool $ok): void
    {
