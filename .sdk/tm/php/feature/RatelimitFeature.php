...
// CustomsWindow SDK ratelimit feature
...
class CustomsWindowRatelimitFeature extends CustomsWindowBaseFeature
{
    ...
    private function _acquire(CustomsWindowContext $ctx): void
    {
    ...
    private function _track(CustomsWindowContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
