...
// CustomsWindow SDK netsim feature
...
class CustomsWindowNetsimFeature extends CustomsWindowBaseFeature
{
    ...
    private function _simulate(CustomsWindowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CustomsWindowContext $ctx, array $applied): void
    {
        $client = $this->client;
