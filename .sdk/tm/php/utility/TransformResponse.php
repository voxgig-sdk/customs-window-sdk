...
// CustomsWindow SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CustomsWindowTransformResponse
{
    public static function call(CustomsWindowContext $ctx): mixed
    {
        ...
        $transform = CustomsWindowHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
