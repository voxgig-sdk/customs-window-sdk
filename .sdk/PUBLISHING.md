...
|---|---|---|
| `ts/` | @voxgig-sdk/customs-window | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/customs-window \
      --repository voxgig-sdk/customs-window-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/customs-window` shows it, and
`npm trust revoke @voxgig-sdk/customs-window --id=<id>` removes it.
