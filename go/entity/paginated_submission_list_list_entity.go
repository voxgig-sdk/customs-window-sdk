...
type PaginatedSubmissionListListEntity struct {
	name    string
...
func NewPaginatedSubmissionListListEntity(client *core.CustomsWindowSDK, entopts map[string]any) *PaginatedSubmissionListListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &PaginatedSubmissionListListEntity{
...
func (e *PaginatedSubmissionListListEntity) GetName() string { return e.name }
...
func (e *PaginatedSubmissionListListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaginatedSubmissionListListEntity) Deleted() bool {
	return e.deleted
}


func (e *PaginatedSubmissionListListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaginatedSubmissionListListEntity(e.client, opts)
}

func (e *PaginatedSubmissionListListEntity) Data(args ...any) any {
...
func (e *PaginatedSubmissionListListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaginatedSubmissionListList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaginatedSubmissionListListEntity) DataTyped(data ...PaginatedSubmissionListList) PaginatedSubmissionListList {
	if len(data) > 0 {
		return typedFrom[PaginatedSubmissionListList](e.Data(asMap(data[0])))
	}
	return typedFrom[PaginatedSubmissionListList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaginatedSubmissionListList (all fields
// optional at the wire level).
func (e *PaginatedSubmissionListListEntity) MatchTyped(match ...PaginatedSubmissionListList) PaginatedSubmissionListList {
	if len(match) > 0 {
		return typedFrom[PaginatedSubmissionListList](e.Match(asMap(match[0])))
	}
	return typedFrom[PaginatedSubmissionListList](e.Match())
}
...
func (e *PaginatedSubmissionListListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaginatedSubmissionListListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PaginatedSubmissionListListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PaginatedSubmissionListListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaginatedSubmissionListListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaginatedSubmissionListListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaginatedSubmissionListListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
