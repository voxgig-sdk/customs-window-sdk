...
type SubmissionDetailEntity struct {
	name    string
...
func NewSubmissionDetailEntity(client *core.CustomsWindowSDK, entopts map[string]any) *SubmissionDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubmissionDetailEntity) GetName() string { return e.name }
...
func (e *SubmissionDetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubmissionDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *SubmissionDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubmissionDetailEntity(e.client, opts)
}

func (e *SubmissionDetailEntity) Data(args ...any) any {
...
func (e *SubmissionDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SubmissionDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubmissionDetailEntity) DataTyped(data ...SubmissionDetail) SubmissionDetail {
	if len(data) > 0 {
		return typedFrom[SubmissionDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[SubmissionDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SubmissionDetail (all fields
// optional at the wire level).
func (e *SubmissionDetailEntity) MatchTyped(match ...SubmissionDetail) SubmissionDetail {
	if len(match) > 0 {
		return typedFrom[SubmissionDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[SubmissionDetail](e.Match())
}
...
func (e *SubmissionDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubmissionDetailEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SubmissionDetailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SubmissionDetailEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SubmissionDetailCreateData and returns an SubmissionDetail. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SubmissionDetailEntity) CreateTyped(reqdata SubmissionDetailCreateData, ctrl map[string]any) (SubmissionDetail, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SubmissionDetail{}, err
	}
	return typedFrom[SubmissionDetail](res), nil
}



func (e *SubmissionDetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubmissionDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubmissionDetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
