...
type PaginatedPartyListListEntity struct {
	name    string
...
func NewPaginatedPartyListListEntity(client *core.CustomsWindowSDK, entopts map[string]any) *PaginatedPartyListListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &PaginatedPartyListListEntity{
...
func (e *PaginatedPartyListListEntity) GetName() string { return e.name }
...
func (e *PaginatedPartyListListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaginatedPartyListListEntity) Deleted() bool {
	return e.deleted
}


func (e *PaginatedPartyListListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaginatedPartyListListEntity(e.client, opts)
}

func (e *PaginatedPartyListListEntity) Data(args ...any) any {
...
func (e *PaginatedPartyListListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaginatedPartyListList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaginatedPartyListListEntity) DataTyped(data ...PaginatedPartyListList) PaginatedPartyListList {
	if len(data) > 0 {
		return typedFrom[PaginatedPartyListList](e.Data(asMap(data[0])))
	}
	return typedFrom[PaginatedPartyListList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaginatedPartyListList (all fields
// optional at the wire level).
func (e *PaginatedPartyListListEntity) MatchTyped(match ...PaginatedPartyListList) PaginatedPartyListList {
	if len(match) > 0 {
		return typedFrom[PaginatedPartyListList](e.Match(asMap(match[0])))
	}
	return typedFrom[PaginatedPartyListList](e.Match())
}
...
func (e *PaginatedPartyListListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaginatedPartyListListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PaginatedPartyListListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PaginatedPartyListListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaginatedPartyListListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaginatedPartyListListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaginatedPartyListListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
