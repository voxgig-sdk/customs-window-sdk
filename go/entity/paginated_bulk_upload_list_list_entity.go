...
type PaginatedBulkUploadListListEntity struct {
	name    string
...
func NewPaginatedBulkUploadListListEntity(client *core.CustomsWindowSDK, entopts map[string]any) *PaginatedBulkUploadListListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &PaginatedBulkUploadListListEntity{
...
func (e *PaginatedBulkUploadListListEntity) GetName() string { return e.name }
...
func (e *PaginatedBulkUploadListListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaginatedBulkUploadListListEntity) Deleted() bool {
	return e.deleted
}


func (e *PaginatedBulkUploadListListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaginatedBulkUploadListListEntity(e.client, opts)
}

func (e *PaginatedBulkUploadListListEntity) Data(args ...any) any {
...
func (e *PaginatedBulkUploadListListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaginatedBulkUploadListList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaginatedBulkUploadListListEntity) DataTyped(data ...PaginatedBulkUploadListList) PaginatedBulkUploadListList {
	if len(data) > 0 {
		return typedFrom[PaginatedBulkUploadListList](e.Data(asMap(data[0])))
	}
	return typedFrom[PaginatedBulkUploadListList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaginatedBulkUploadListList (all fields
// optional at the wire level).
func (e *PaginatedBulkUploadListListEntity) MatchTyped(match ...PaginatedBulkUploadListList) PaginatedBulkUploadListList {
	if len(match) > 0 {
		return typedFrom[PaginatedBulkUploadListList](e.Match(asMap(match[0])))
	}
	return typedFrom[PaginatedBulkUploadListList](e.Match())
}
...
func (e *PaginatedBulkUploadListListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaginatedBulkUploadListListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PaginatedBulkUploadListListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PaginatedBulkUploadListListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaginatedBulkUploadListListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaginatedBulkUploadListListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaginatedBulkUploadListListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
