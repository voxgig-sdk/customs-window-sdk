...
func NewPartyEntity(client *core.CustomsWindowSDK, entopts map[string]any) *PartyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PartyEntity) GetName() string { return e.name }
...
func (e *PartyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PartyEntity) Deleted() bool {
	return e.deleted
}


func (e *PartyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPartyEntity(e.client, opts)
}

func (e *PartyEntity) Data(args ...any) any {
...
func (e *PartyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Party; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PartyEntity) DataTyped(data ...Party) Party {
	if len(data) > 0 {
		return typedFrom[Party](e.Data(asMap(data[0])))
	}
	return typedFrom[Party](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Party (all fields
// optional at the wire level).
func (e *PartyEntity) MatchTyped(match ...Party) Party {
	if len(match) > 0 {
		return typedFrom[Party](e.Match(asMap(match[0])))
	}
	return typedFrom[Party](e.Match())
}
...
func (e *PartyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PartyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PartyLoadMatch and returns an Party. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PartyEntity) LoadTyped(reqmatch PartyLoadMatch, ctrl map[string]any) (Party, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Party{}, err
	}
	return typedFrom[Party](res), nil
}




func (e *PartyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PartyListMatch and returns []Party. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PartyEntity) ListTyped(reqmatch PartyListMatch, ctrl map[string]any) ([]Party, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Party](res), nil
}




func (e *PartyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PartyCreateData and returns an Party. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PartyEntity) CreateTyped(reqdata PartyCreateData, ctrl map[string]any) (Party, error) {
...
func (e *PartyEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PartyUpdateData and returns an Party. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PartyEntity) UpdateTyped(reqdata PartyUpdateData, ctrl map[string]any) (Party, error) {
...
func (e *PartyEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PartyRemoveMatch and returns an Party. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PartyEntity) RemoveTyped(reqmatch PartyRemoveMatch, ctrl map[string]any) (Party, error) {
...
func (e *PartyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
